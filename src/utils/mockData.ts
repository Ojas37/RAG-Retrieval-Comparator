...
export const MOCK_TERMINAL_LOGS: string[] = [
  ...
  '⚙️ [CONFIG] Embedding dimension: 384 (BAAI/bge-small-en-v1.5)',
  ...
  '🚀 [EMBEDDING] Commencing batch document embeddings via BAAI/bge-small-en-v1.5 locally ...',
  '🚀 [EMBEDDING] Processing batch 1/49 (500 chunks) ... success [Avg Latency 42ms]',
  '🚀 [EMBEDDING] Processing batch 10/49 (500 chunks) ... success [Avg Latency 45ms]',
  '🚀 [EMBEDDING] Processing batch 25/49 (500 chunks) ... success [Avg Latency 38ms]',
  '🚀 [EMBEDDING] Processing batch 40/49 (500 chunks) ... success [Avg Latency 41ms]',
  '🚀 [EMBEDDING] Processing batch 49/49 (105 chunks) ... success [Avg Latency 35ms]',
  '🟢 [EMBEDDING] Embedded all chunks locally! Accumulated tokens: 11,208,450.',
  '💰 [EMBEDDING] Estimated embedding API costs: $0.00 USD (100% Free & Local).',
  '🐘 [PGVECTOR] Dropping existing vectors table if exists: "rag_vectors" ...',
  '🐘 [PGVECTOR] Creating vectors table "rag_vectors" with columns: [id, document_id, embedding vector(384), sparse_tokens tsvector, metadata jsonb] ...',
